    ...
    <div class="page-content" >
        ...
        <div class="page-breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Calidad por Antena</li>
            </ul>
        </div>
        <!-- /Page Breadcrumb -->
        <!-- Page Header -->
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-12">
                                            <div class="buttons-preview">
                                                <a href="javascript:void(InitiateFlotSelectableChartPotenciaMWCambium.init());" class="btn btn-azure">Potencia Tx</a>
                                                <a href="javascript:void(0);" class="btn btn-azure">Potencia Rx</a>
                                                <a href="javascript:void(0);" class="btn btn-azure">Modulación</a>
                                                <a href="javascript:void(0);" class="btn btn-azure">Atenuación</a>
