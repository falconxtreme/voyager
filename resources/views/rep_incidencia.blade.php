    ...
    <div class="page-content" >
        ...
        <div class="page-breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Reportes de Tasa de Incidencias de averías</li>
            </ul>
        </div>
        <!-- /Page Breadcrumb -->
        <!-- Page Header -->
            ...
            <div class="header-title">
                <h1>
                    ...
                    <small>
                        ...
                        Reportes de Tasa de Incidencias de averías
                    </small>
                </h1>
            </div>
            <!--Header Buttons-->
                            ...
                            <div id="registration-form">
                                <form role="form">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <span class="input-icon icon-right">
                                                    <input type="text" class="form-control" id="codigoUbigeoInput" placeholder="Código de Reporte">
                                        ...
                                        <div class="col-sm-6">
                                             <div class="form-group">
                                                <select id="ddlMedioReporte" multiple="multiple" style="width: 100%;">
                                                    <option value="RIAI" />Teléfono
                                                    <option value="RIAX" />Mail
                                                    <option value="RISSS" />Presencial
                                                    <option value="RIP" />Escrito
                                                </select>
                                            </div>
                                        </div>
                                    </div>
