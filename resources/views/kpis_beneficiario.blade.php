    ...
    <div class="page-content" >
        ...
        <div class="page-breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Calidad por Beneficiario</li>
            </ul>
        </div>
        <!-- /Page Breadcrumb -->
        <!-- Page Header -->
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-12">
                                            <div class="buttons-preview">
                                                <a href="javascript:void(0);" class="btn btn-azure">Latencia</a>
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-azure">Tráfico consumido</a>
                                                <a href="javascript:void(0);" class="btn btn-azure">Jitter</a>
                                                <a href="javascript:void(0);" class="btn btn-azure">Ancho de banda</a>
                                                <a href="javascript:void(0);" class="btn btn-azure">Porcentaje de congestión</a>
                                                <a href="javascript:void(0);" class="btn btn-azure">Simultaneidad</a>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xs-12 col-md-12">
                                            <div class="widget">
                                                <div class="widget-header ">
                                                    <span class="widget-caption">Latencia</span>
