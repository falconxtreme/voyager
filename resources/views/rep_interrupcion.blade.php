    ...
    <div class="page-content" >
        ...
        <div class="page-breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Reportes de Interrupción del Servicio</li>
            </ul>
        </div>
        <!-- /Page Breadcrumb -->
        <!-- Page Header -->
            ...
            <div class="header-title">
                <h1>
                    ...
                    <small>
                        ...
                        Reportes de Interrupción del Servicio
                    </small>
                </h1>
            </div>
            <!--Header Buttons-->
                            ...
                            <div id="registration-form">
                                <form role="form">
                                    <div class="form-title">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <a class="btn btn-blue" href="javascript:void(0);">Interrupción de acceso a internet</a>&nbsp;
                                                 <a class="btn btn-blue" href="javascript:void(0);">nterrupción de acceso a intranet</a>&nbsp;
                                                 <a class="btn btn-blue" href="javascript:void(0);">Interrupción del subsistema de seguimiento</a>&nbsp;
                                                 <!--
                                                <select id="e2" multiple="multiple" style="width: 100%;">
                                                    <option value="RIAI" />Interrupción de acceso a internet
                                                    <option value="RIAX" />Interrupción de acceso a intranet
                                                    <option value="RISSS" />Interrupción del subsistema de seguimiento
                                                    <option value="RIP" />Interrupción del POP
                                                </select>
                                                 -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                 <a class="btn btn-blue" href="javascript:void(0);">Interrupción del POP</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
