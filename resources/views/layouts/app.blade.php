            ...
            <div class="clearfix">
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        <?php $admin_logo_img = Voyager::setting('general.icon_image', ''); ?>
                        @if($admin_logo_img == '')
                        ...
                        <div class="copy animated fadeIn">
                            <h1>{{ Voyager::setting('general.title', 'Voyager') }}</h1>
                            <p>{{ Voyager::setting('general.description', __('voyager.login.welcome')) }}</p>
                        </div>
