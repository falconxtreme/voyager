    ...
    <div class="page-content" >
        ...
        <div class="page-breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Reportes de Monitoreo de parámetros</li>
            </ul>
        </div>
        <!-- /Page Breadcrumb -->
        <!-- Page Header -->
            ...
            <div class="header-title">
                <h1>
                    ...
                    <small>
                        ...
                        Reportes de Monitoreo de parámetros
                    </small>
                </h1>
            </div>
            <!--Header Buttons-->
                            ...
                            <div id="registration-form">
                                <form role="form">
                                    <div class="form-title">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <a class="btn btn-blue" href="javascript:void(0);">Reporte de Disponibilidad</a>&nbsp;
                                                 <a class="btn btn-blue" href="javascript:void(0);">Reporte de uso del servicio</a>&nbsp;
                                                 <a class="btn btn-blue" href="javascript:void(0);">Reporte de Calidad</a>
                                                <!--
                                                    <select id="e2" multiple="multiple" style="width: 100%;">
                                                    <option value="RDD" />Reporte de Disponibilidad
                                                    <option value="RUS" />Reporte de uso del servicio
                                                    <option value="RDC" />Reporte de Calidad
                                                </select>    
                                                -->
                                            </div>
                                        </div>
