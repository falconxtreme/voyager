    ...
    return {
        init: function () {
            ...
            var data = [{
                color: themeprimary,
                label: "CPU",
                data: [[8.0, 90], [8.5, 70], [9.0, 60], [9.5, 80], [10.0, 30], [10.5, 45]]
            }
            ];
...
var InitiateStackedChartLatencia = function () {
    return {
        init: function () {
            var d1 = [];
            for (var i = 0; i <= 10; i += 1)
...
var InitiateFlotSelectableChartLatencia = function () {
    return {
        init: function () {
            ...
            var data = [{
                color: themeprimary,
                label: "Latencia",
                data: [[1.0, 90], [2.0, 70], [3.0, 60], [4.0, 80], [5.0, 30], [6.0, 45]]
            }
            ];
            ...
            var options = {
                ...
                tooltipOpts: {
                    defaultTheme: false,
                    content: "<b>%s</b> : <span>Minuto %x</span> : <span>%y ms</span>",
                },
                crosshair: {
                    mode: "x"
                }
...
var InitiateFlotSelectableChartPotenciaMWCambium = function () {
    return {
        init: function () {
            ...
            var options = {
                ...
                tooltipOpts: {
                    defaultTheme: false,
                    content: "<b>%s</b> : <span>Minuto %x</span> : <span>%y </span>",
                },
                crosshair: {
                    mode: "x"
                }
...
var InitiateFlotSelectableChartPotenciaSWCisco = function () {
    return {
        init: function () {
